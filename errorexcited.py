...
def inputcreator(dipole,xyz,filename,num):
    ...
    filename.write('s,He,0.0252600,0.0062100,0.0015267,0.0003753,0.0000923,0.0000227,0.00000557,0.00000137,0.000000337,0.0000000829,0.0000000204,0.000000005;\n')
    filename.write('p,He,0.1020000,0.0268000,0.0070416,0.0018502,0.0004861,0.0001277,0.0000336,0.0000088,0.00000232,0.000000609,0.000000160,0.000000042;\n')
    filename.write('d,He,0.2470000,0.0577000,0.0134789,0.0031487,0.0007356,0.0001718,0.00004014;\n}\n')
...
def Main():
    path_to_exc_calcs = '/ddn/home8/r2891/chem/quad/naph/CNCN/EOM/apvdz+12s12p7d/2Naph'
    path_to_anion_dipole_moments = '/ddn/home8/r2891/chem/quad/naph/CNCN/EOM/aniondipole/2Naph'
